...
const Works = () => (
  <>
    ...
    >
      Projetos que mostram como eu resolvo problema de verdade — de visão
      computacional e modelos de classificação a sistemas internos que tiram
      trabalho manual da frente de uma equipe. Toque no card para abrir o
      repositório.
    </motion.p>
